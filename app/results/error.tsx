/**
 * /results error boundary. Catches the real failure mode — Supabase
 * unreachable mid-request — and offers a retry instead of a blank crash.
 * Mirrors the not-found page's Midnight Draw mesh treatment.
 */
"use client";
