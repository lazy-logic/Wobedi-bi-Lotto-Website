  ...
  return (
    ...
    >
      ...
      {/* Flowing "corporate wave" ribbon — tonal-blue curves sweeping across
          ...
          Shorter on small mobile so the compressed curves don't dominate the
          title block. Shared with the LatestDrawCard footer via WaveRibbon. */}
      <WaveRibbon className="pointer-events-none absolute inset-x-0 bottom-0 w-full h-[45%] sm:h-[55%] md:h-[68%]" />
